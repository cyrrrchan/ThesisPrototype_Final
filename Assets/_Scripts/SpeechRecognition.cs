...
public class SpeechRecognition : MonoBehaviour
{
    ...
    private string stt_username = "7a416f0b-6a9e-4ddb-a493-165149fb0509";
    private string stt_password = "ygKPIUakHUwA";
    // Change stt_url if different from below
    private string stt_url = "https://stream.watsonplatform.net/speech-to-text/api";

    private string convo_username = "a0a60346-5e86-4b23-8880-4659e0d1a2c4";
    private string convo_password = "noTPQG1ZOgM6";
