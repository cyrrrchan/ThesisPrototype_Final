...
{
    private string _username = "a0a60346-5e86-4b23-8880-4659e0d1a2c4";
    private string _password = "noTPQG1ZOgM6";
    private string _url = "https://gateway.watsonplatform.net/conversation/api";
    private string _workspaceId = "eee0af17-49fe-41a1-856f-435448ca3127";
